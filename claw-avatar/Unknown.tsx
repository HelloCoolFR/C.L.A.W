...
import { avatarData, type AnimationName } from './unknown.avatar'

export type { AnimationName } from './unknown.avatar'
...
export const Unknown = forwardRef<AvatarHandle, AvatarProps>(function Unknown(
  {
    animation = "sleeping",
    playing = true,
    loop,
